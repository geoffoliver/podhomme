...
To set a password or configure other options, create a `.env` file in the directory where you're running the command (use [`.env.example`](.env.example) as a template) before starting.
